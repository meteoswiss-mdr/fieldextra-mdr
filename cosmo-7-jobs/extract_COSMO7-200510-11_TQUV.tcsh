...
set mms =   (10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11)
set yyyys = (2005)
set yys =   (05) 
set hh =    (00)
set levellist = "levmin=1,levmax=61"
set levellist1 = "levmin=0,levmax=61"
...
set wdir = /store/s83/strefalt/phd_wind_hail/data/model/cosmo-7/LA
...
#foreach model ($archivedirs)
    ...
    echo "-----------------------------------------------------------------------------"
    echo "archive directory of cosmo analysis (coarse): $adir"
    ...
    echo "working directory of cosmo analysis (coarse): $destination"
