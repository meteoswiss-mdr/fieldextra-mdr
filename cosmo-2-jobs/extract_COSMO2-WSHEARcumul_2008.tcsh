...
&Process
  in_type = "INCORE"
  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_WSHEARcu"
...
&Process_in_field = "HHL"/

&Process tmp1_field = "U", voper="intpl_k2z,lnp",voper_lev=0,3000,6000, hoper='diskavg,3', tag="smooth_u_on_z" /
&Process tmp1_field = "V", voper="intpl_k2z,lnp",voper_lev=0,3000,6000, hoper='diskavg,3', tag="smooth_v_on_z" /
&Process tmp1_field = "U", hoper='diskavg,3', tag="smooth_u_on_k"/
&Process tmp1_field = "V", hoper='diskavg,3', tag="smooth_v_on_k"/
&Process tmp1_field = "U", voper="intpl_k2z,lnp",voper_lev=0,3000,6000, tag="u_on_z" /
&Process tmp1_field = "V", voper="intpl_k2z,lnp",voper_lev=0,3000,6000, tag="v_on_z" /
...
!---------------------------------------------------------------------------------------
&Process out_field = "WSHEARL", use_tag="u_for_wshear,v_for_wshear"/
&Process out_field = "WSHEARM", use_tag="u_for_wshear,v_for_wshear"/
&Process out_field = "WSHEARU", use_tag="u_for_wshear,v_for_wshear"/
