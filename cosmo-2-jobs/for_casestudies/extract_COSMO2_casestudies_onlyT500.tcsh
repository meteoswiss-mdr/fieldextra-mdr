...
&Process
  in_type = "INCORE"
  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_TQVUVnew"
...
&Process tmp1_field = "T",voper="intpl_k2p,lnp", voper_lev=250,500,700,850 /
&Process tmp1_field = "QV", voper="intpl_k2p,lnp", voper_lev=250,500,700,850 /
&Process tmp1_field = "U", poper = "n2geog", voper="intpl_k2p,lnp", voper_lev=250,500,700,850  /
&Process tmp1_field = "V", poper = "n2geog", voper="intpl_k2p,lnp", voper_lev=250,500,700,850  /
