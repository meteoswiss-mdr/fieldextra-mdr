...
&Process
  in_type = "INCORE"
  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_MCONV_1500m3000m" 
...
&Process tmp3_field = "MCONV", voper="integ_sfc2h", voper_lev=200,500,1500,3000/
&Process tmp3_field = "U", hoper="destagger",voper="intpl_k2h,lnp", voper_lev=200,500,1500,3000/
&Process tmp3_field = "V", hoper="destagger",voper="intpl_k2h,lnp", voper_lev=200,500,1500,3000/
