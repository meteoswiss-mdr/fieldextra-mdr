...
&Process
  in_type = "INCORE"
  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_TQVUV"
  tstart=$tstart, tstop=$tstop, tincr=1
...
&Process tmp1_field = "T",voper="intpl_k2p,lnp", voper_lev=700,850,500,250 /
&Process tmp1_field = "U", poper = "n2geog", voper="intpl_k2p,lnp", voper_lev=700,850,500,250  /
&Process tmp1_field = "V", poper = "n2geog", voper="intpl_k2p,lnp", voper_lev=700,850,500,250  /
&Process tmp1_field = "PMSL"/
&Process tmp1_field = "QV", voper="intpl_k2p,lnp", voper_lev=700,850,500,250 /
...
!--------------------------------------------------------
! Fields 3: U_10M, V_10M, FF_10M, DD_10M, W_DIV_H
!--------------------------------------------------------

!&Process
!  in_file="$destination/lfff<DDHH>0000"
!  tstart=$tstart, tstop=$tstop, tincr=1, tlag = -2,0,1
!  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_wind"
!  out_type="NETCDF"
!/
!---------------------------------------------------------------------------------------
! Define fields to extract:
