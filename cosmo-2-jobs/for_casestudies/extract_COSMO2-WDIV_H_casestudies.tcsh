...
&Process
  in_type = "INCORE"
  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_WDIV_H_pres"
...
&Process tmp2_field = "P"/
&Process tmp2_field = "HHL"/
&Process tmp2_field = "HSURF"/
&Process tmp2_field = "HFL"/
!&Process tmp2_field = "WDIV_H", voper="integ_sfc2h", voper_lev=200,500,1000,1500,3000/
&Process tmp2_field = "WDIV_H", voper="intpl_k2p,lnp", voper_lev=925,900,875,850,825,800,700,500/

&Process out_field = "WDIV_H"/
