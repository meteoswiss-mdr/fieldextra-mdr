...
set dds         = (01 02 03 04 05 06 07 08 09 10 11 12 13 14 15 16 17 18)
set mms         = (04 04 04 04 04 04 04 04 04 04 04 04 04 04 04 04 04 04)
set yyyys 	= (2014)
set yys 	= (14)
set hh 		= (00)
set tstarts     = (00)
...
&Process
  in_type = "INCORE"
  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_T_QV_UV_700_850" 
