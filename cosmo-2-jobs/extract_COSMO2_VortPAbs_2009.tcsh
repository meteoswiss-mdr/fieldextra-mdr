...
&Process
  in_type = "INCORE"
  out_file="$destination/$yyyy$mm$dd${hh}_<HH>_cosmo2_VortPAbs" 
...
&Process tmp1_field = "U",hoper="destagger",voper="intpl_k2p,lnp", voper_lev=300,400,500/
&Process tmp1_field = "V",hoper="destagger",voper="intpl_k2p,lnp", voper_lev=300,400,500/
